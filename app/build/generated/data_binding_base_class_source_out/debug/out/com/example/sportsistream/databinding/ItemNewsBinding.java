...
public final class ItemNewsBinding implements ViewBinding {
  ...
  private ItemNewsBinding(@NonNull CardView rootView, @NonNull ImageView ivBookmark,
      @NonNull ImageView ivImage, @NonNull TextView tvCategory, @NonNull TextView tvDate,
  ...
  public static ItemNewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNewsBinding((CardView) rootView, ivBookmark, ivImage, tvCategory, tvDate,
          tvTitle);
    }
