...
public final class FragmentPlaylistBinding implements ViewBinding {
  ...
  private FragmentPlaylistBinding(@NonNull LinearLayout rootView, @NonNull ImageButton btnBack,
      @NonNull ImageButton btnLogout, @NonNull RecyclerView rvPlaylist, @NonNull TextView tvEmpty,
  ...
  public static FragmentPlaylistBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPlaylistBinding((LinearLayout) rootView, btnBack, btnLogout, rvPlaylist,
          tvEmpty, tvSubtitle);
    }
